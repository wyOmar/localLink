  ...
  navigator.mediaDevices
    .getDisplayMedia({
      ...
      audio: {
        ...
        autoGainControl: false, // Added: Stops volume normalization buffering
        latency: 0              // Added: Hints browser to prioritize speed
      },
    })
    .then((mediaStream) => {
      stream = mediaStream;
...
function createPeerConnection(watcherId, quality) {
  ...
  if (stream) {
    ...
    // ONLY add the video track if it's not "audioOnly"
